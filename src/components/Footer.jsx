...
const ICON_MAP = { FaLinkedin, FaGithub, FaFacebook, FaInstagram, FaWhatsapp };
...
const Footer = memo(() => {
  ...
  const links = socialLinks.length > 0 ? socialLinks : FALLBACK_LINKS;
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto flex flex-col items-center gap-6">
        {/* Social links — driven by Supabase contact_info */}
        <div className="flex flex-wrap justify-center gap-3">
          {links.map(({ icon: iconName, label, href, color }) => {
        ...
        <div className="text-center space-y-1">
          ...
          <p className="text-slate-400 text-sm">
            ...
            <span className="text-indigo-500 font-mono" aria-hidden="true">&lt;/&gt;</span>
          </p>
        </div>
